...
def generate_video_summary(document: AnalysisDocument, client: LLMClient, logger: RunLogger) -> None:
    ...
    for attempt in range(1, 3):
        ...
        try:
            raw = client.generate_json_text(prompt, system_prompt="你负责汇总整个影音片段。只依据提供的数据，用中文返回合法JSON。")
